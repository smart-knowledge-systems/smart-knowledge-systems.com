    ...
    <div className="bg-white px-6 py-32 lg:px-8">
      <div className="mx-auto max-w-3xl text-base/7 text-gray-700">
        ...
        <p className="mt-6 text-xl/8">
          {mainContent.intro.subtitle}
        </p>
        <div className="mt-10 max-w-2xl">
          <p>
            {mainContent.mainContent.paragraph1}
          </p>
          ...
          <figure className="mt-10 border-l border-indigo-600 pl-9">
            ...
            <figcaption className="mt-6 flex gap-x-4">
              <Image
                ...
                height={mainContent.secondSection.testimonial.author.image.height}
              />
              <div className="text-sm/6">
                <strong className="font-semibold text-gray-900">{mainContent.secondSection.testimonial.author.name}</strong> – {mainContent.secondSection.testimonial.author.title}
              </div>
            </figcaption>
          </figure>
          <p className="mt-10">
            {mainContent.secondSection.paragraph2}
          </p>
        </div>
        ...
        <div className="mt-16 max-w-2xl">
          ...
          <p className="mt-6">
            {mainContent.finalSection.paragraph1}
          </p>
          <p className="mt-8">
            {mainContent.finalSection.paragraph2}
          </p>
        </div>
      </div>
    </div>
